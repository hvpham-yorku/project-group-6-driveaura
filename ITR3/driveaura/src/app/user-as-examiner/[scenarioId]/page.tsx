        ...
        {submitted && (
          <>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/user-as-examiner"
                className="inline-flex items-center justify-center rounded-lg bg-crimson-spark px-5 py-2.5 text-sm font-medium text-ghost-white transition-colors hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-electric-cyan focus:ring-offset-2 focus:ring-offset-void-purple"
              >
                Back to scenarios
              </Link>
              <button
